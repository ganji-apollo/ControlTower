__all__ = ('EVENT_SCHEDULER_START', 'EVENT_SCHEDULER_SHUTDOWN',
           ...
           'EVENT_JOB_STARTED', 'EVENT_JOB_UPDATED', 'EVENT_ALL', 
           'EVENT_JOB_MAXINSTANCE',
           'SchedulerEvent', 'JobStoreEvent', 'JobEvent')
...
EVENT_JOB_UPDATED = 512          # A jobstore's job was updated
EVENT_JOB_STARTED = 1024         # A job was started
EVENT_JOB_MAXINSTANCE = 2048     # A job's instance reach the max
EVENT_ALL = (EVENT_SCHEDULER_START | EVENT_SCHEDULER_SHUTDOWN |
             EVENT_JOBSTORE_ADDED | EVENT_JOBSTORE_REMOVED |
             EVENT_JOBSTORE_JOB_ADDED | EVENT_JOBSTORE_JOB_REMOVED |
             EVENT_JOB_EXECUTED | EVENT_JOB_ERROR | EVENT_JOB_MISSED |
             EVENT_JOB_UPDATED | EVENT_JOB_STARTED| EVENT_JOB_MAXINSTANCE)
